...
public interface UpgradeRenderer {
     ...
     * values {@code None} and {@code Any}.
     * <br>
     * {@code None} means that the upgrade should not be rendered at all. This
     * can be the case when there is no slot remaining that the upgrade may be
     * rendered in. Returning {@code null} is equivalent to returning {@code None}.
     * <br>
     * {@code Any} means that the upgrade doesn't really care where it's being
     ...
     * be equivalent to returning {@code None}.
     *
