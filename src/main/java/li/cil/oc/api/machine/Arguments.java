 ...
 * {@code checkInteger} you'll get a {@code 1}.
 * <br>
...
public interface Arguments extends Iterable<Object> {
     ...
     * <li>{@code java.lang.Boolean} if the Lua value was a boolean.</li>
     * <li>{@code java.lang.Double} if the Lua value was a number.</li>
