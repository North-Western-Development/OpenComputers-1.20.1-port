...
object TransposerRenderer extends Function[BlockRenderDispatcher, TransposerRenderer] {
  override def apply(dispatch: BlockRenderDispatcher) = new TransposerRenderer(dispatch)
}
