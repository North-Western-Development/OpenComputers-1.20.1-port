...
//
//object HoverBootRenderer extends HumanoidModel[LivingEntity](0.5f) {
...
//  bootLeft.y = 10.11f
//
//  droneBody.texOffs(0, 23).addBox(-3, 1, -3, 6, 1, 6).getYRot = math.toRadians(45).toFloat // top
//  droneBody.texOffs(0, 1).addBox(-1, 0, -1, 2, 1, 2).getYRot = math.toRadians(45).toFloat // middle
//  droneBody.texOffs(0, 17).addBox(-2, -1, -2, 4, 1, 4).getYRot = math.toRadians(45).toFloat // bottom
