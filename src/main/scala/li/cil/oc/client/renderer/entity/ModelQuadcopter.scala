...
//  texHeight = 32
//
//  body.texOffs(0, 23).addBox(-3, 1, -3, 6, 1, 6).getYRot = math.toRadians(45).toFloat // top
//  body.texOffs(0, 1).addBox(-1, 0, -1, 2, 1, 2).getYRot = math.toRadians(45).toFloat // middle
//  body.texOffs(0, 17).addBox(-2, -1, -2, 4, 1, 4).getYRot = math.toRadians(45).toFloat // bottom
...
//
//    wing0.getXRot = drone.flapAngles(0)(0)
//    wing0.zRot = drone.flapAngles(0)(1)
//    wing1.getXRot = drone.flapAngles(1)(0)
//    wing1.zRot = drone.flapAngles(1)(1)
//    wing2.getXRot = drone.flapAngles(2)(0)
//    wing2.zRot = drone.flapAngles(2)(1)
//    wing3.getXRot = drone.flapAngles(3)(0)
...
//
//    if (drone.isRunning) {
//      light0.getXRot = drone.flapAngles(0)(0)
//      light0.zRot = drone.flapAngles(0)(1)
//      light1.getXRot = drone.flapAngles(1)(0)
//      light1.zRot = drone.flapAngles(1)(1)
//      light2.getXRot = drone.flapAngles(2)(0)
//      light2.zRot = drone.flapAngles(2)(1)
//      light3.getXRot = drone.flapAngles(3)(0)
