...
object KeyBindings {
  ...
  val extendedTooltip = new KeyMapping("key.opencomputers.extendedTooltip", KeyConflictContext.GUI,
    KeyModifier.NONE, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_LEFT_SHIFT, OpenComputers.Name)

  val analyzeCopyAddr = new KeyMapping("key.opencomputers.analyzeCopyAddress", KeyConflictContext.IN_GAME,
    KeyModifier.NONE, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_LEFT_CONTROL, OpenComputers.Name)

  val clipboardPaste = new KeyMapping("key.opencomputers.clipboardPaste", textInputConflict,
    KeyModifier.NONE, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_INSERT, OpenComputers.Name)
}