...
object Cable {
  ...
  def updateState(state: BlockState, tileEntity: BlockEntity, defaultColor: Int, fromSide: Direction, fromState: BlockState, world: LevelAccessor, fromPos: BlockPos): BlockState = {
