...
//          tooltip.add(Component.literal(Localization.Assembler.Progress(progress, timeRemaining)))
//          if (tag.contains("output")) {
//            val output = tag.getString("output")
//            tooltip.add(Component.literal("Building: " + Localization.localizeImmediately(output)))
//          }
//        }
